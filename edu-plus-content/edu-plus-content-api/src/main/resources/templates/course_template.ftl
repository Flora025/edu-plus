    ...
    <div class="article-banner">
        ...
        <div class="banner-info">
            ...
            <div class="banner-rit">
                <p>
                  <a href="http://localhost:8080/course/preview/learning.html?id=82" target="_blank">
                        ...
                        <div class="content">
                            <div class="item">
                                ...
                                <div class="drop-down" style="height: 260px;">
                                    <ul class="list-box">
                                        <li class="active"><a href="http://localhost:8080/course/preview/learning.html?id=82&chapter=149" target=_blank>1.1 阅读：分级政策细节</a> <span>97’33”</span></li>
