package com.edu.checkcode.service;

import com.edu.checkcode.model.CheckCodeParamsDto;
import com.edu.checkcode.model.CheckCodeResultDto;
import lombok.Data;
...
public abstract class AbstractCheckCodeService implements CheckCodeService {
     ...
     * @param expire 过期时间
     * @return com.edu.checkcode.service.AbstractCheckCodeService.GenerateResult 生成结果
     * @author Mr.M
     * @date 2022/9/30 6:07
    */
