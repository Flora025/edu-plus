...
import com.edu.ucenter.mapper.XcUserRoleMapper;
...
import com.edu.ucenter.model.po.XcUserRole;
...
public class WxAuthServiceImpl implements AuthService, WxAuthService {
    ...
    private Map<String, String> getUserinfo(String accessToken, String openid) {
        ...
        String result = new String(
                exchange.getBody().getBytes(StandardCharsets.ISO_8859_1),
