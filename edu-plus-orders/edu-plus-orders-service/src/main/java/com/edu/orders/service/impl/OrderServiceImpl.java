...
import com.edu.orders.config.AlipayConfig;
import com.edu.orders.config.PayNotifyConfig;
...
public class OrderServiceImpl implements OrderService {
    ...
    public PayRecordDto queryPayResult(String payNo) {
        ...
        if (payRecord == null) {
            EduPlusException.cast("请重新点击支付获取二维码");
        }
        //支付状态
    ...
    public PayStatusDto queryPayResultFromAlipay(String payNo) {
        ...
        try {
            ...
            if (!response.isSuccess()) {
                EduPlusException.cast("请求支付查询查询失败");
            }
    ...
    public void saveAliPayStatus(PayStatusDto payStatusDto) {
        ...
        if (trade_status.equals("TRADE_SUCCESS")) {
            ...
            if (orders == null) {
                ...
                EduPlusException.cast("根据支付记录找不到订单");
            }
            ...
            if (update > 0) {
                ...
                EduPlusException.cast("更新订单表状态失败");
            }
